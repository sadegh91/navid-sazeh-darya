...
<fieldset class="form-label-group" style="margin-top: 4px">
    ...
    <input style="color: black;" type="password" class="form-control @error($name) is-invalid @enderror" id="{{$name}}" name="{{$name}}" value="{{old($name)}}" maxlength="{{$length}}" placeholder="{{$title}}">
