...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		//pathToFolder: '../../panel_assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
		pathToFolder: 'http://localhost/navid_sazeh_darya/public/panel_assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
